...
def Init_of_secondary_parameters(cfg):
    ...
    for var in tqdm(cfg.patch.patch_data) :
        ...
        filename = next(os.scandir(cfg.data.dataset_path + '/patches_'+ var )).name
    ...
    for var in cfg.patch.patch_data:
        ...
        # prise en compte de cas particulié où le nombre de bands et modifié avec des augmentations
        if var == 'substrate' :
    ...
    return cls_num_list_train, patch_data_ext, cfg, cfg_modif, patch_band
